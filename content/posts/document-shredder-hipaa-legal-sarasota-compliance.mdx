...
security questionnaires for Florida medical and legal practices may include questions about physical-record destruction. A written disposal policy and a real cross-cut or micro-cut shredder are simple proof that paper records are not being tossed into normal trash.
