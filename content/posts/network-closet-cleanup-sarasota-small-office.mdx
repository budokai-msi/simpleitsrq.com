...
title: "Network Closet Cleanup for Small Offices"
metaDescription: "A messy network closet causes outages and slow troubleshooting. Here is the rack, patch panel, switch, UPS, and labeling plan we use."
date: "2026-04-15"
...
tags:
  ...
  - "smb"
  - "sarasota"
excerpt: "If your network closet has unlabeled cables, consumer switches on a shelf, and a power strip dangling from a hook, this is the fix."
...
Use the [network closet calculator on Tools](/tools#calculators) to estimate rack size, UPS size, and switch port count before buying.
...
1. Take photos before moving anything.
2. Count active wall jacks, access points, phones, cameras, and printers.
3. Label the cables you already understand.
4. Move network gear off the floor before hurricane season.
5. Put the modem, firewall, switch, and access points on a UPS.
6. Keep a printed port map in the closet.
