...
- Tie the device into your [endpoint inventory and security documentation](/#solutions). Just because it does not run Windows does not mean you can pretend it does not exist.
