...
title: "GitHub Copilot Private Repo Opt-Out Deadline"
...
This is the kind of one-day project we run as part of our [compliance and security documentation work](/#solutions) for local clients. If your team does not have time to do it before April 24, that is the highest-priority item we can take off your plate.
