...
tags:
  ...
  - venice
  - hardware
excerpt: "A practical security-camera guide for Sarasota and Bradenton businesses: Reolink vs UniFi vs enterprise systems, installed cost, and Florida install gotchas."
...
2. **Risk reviews flag them.** IT vendors increasingly flag Hikvision/Dahua during risk reviews. "Yes" is no longer a harmless answer if the system is exposed to the internet or used in a sensitive environment.
...
1. Decide what you need to identify: faces, license plates, packages, doors, register activity, or general motion.
2. Take photos of each camera location in daylight and at night.
3. Check whether there is Ethernet near those locations.
4. Decide whether you want local recording, cloud recording, or both.
5. Use [Tools](/tools#calculators) to sanity-check the network closet and UPS before adding PoE cameras.
...
If you already know you want a 4-camera UniFi Protect install, **[reserve your install slot online through Services](/services#camera-install-deposit)** with a $500 deposit that credits toward the project. Skips the quote stage entirely.
