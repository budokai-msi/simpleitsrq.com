...
title: "AI Vendor Lock-In Is the Default. The Anthropic Wrapper Block Just Made It Visible."
metaDescription: "Anthropic blocked third-party tools from paid Claude Code accounts with no notice. The technical detail is narrow. The structural pattern — every AI vendor will eventually do this — is what your procurement process needs to assume from now on."
date: "2026-04-03"
