...
| **Privacy / Email** | **Mask Personal Email** | `Signed in to Client Portal` | Exposing raw email (`ivanovspccenter@gmail.com`) in forms |
| **Admin Owner** | `ivanovspccenter@gmail.com` | Hardcoded sole owner in `api/_lib/admin.js` | Env var fallback for admin access |
