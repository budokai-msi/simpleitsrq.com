...
- **PRIVACY & EMAIL MASKING**: Never print raw email addresses (e.g. `ivanovspccenter@gmail.com`) on public form headers or banners. Always use masked role text (e.g. `Signed in to Client Portal`).
- **SOLE ADMIN OWNER**: `OWNER_EMAIL = "ivanovspccenter@gmail.com"` in `api/_lib/admin.js`.
- **CSS SELECTORS**:
