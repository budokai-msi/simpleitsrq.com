...
export const services = [
  ...
  {
    slug: "copier-fax-integration",
    title: "Copier & Fax Network Integration",
    tagline: "We'll wire your office hardware into your network, set up scan-to-folder, and move you to Fax-over-Email.",
    audience: "Business",
    audiences: ["Business"],
    price: 499,
    priceNote: "Up to 3 devices. Advanced print-server setups: separate quote.",
    duration: "Single visit, 2–4 hours",
    contents: [
    ...
    notInScope: [
      "Physical repair of broken hardware (call the lease vendor)",
      "Moving 500lb copiers between floors",
    ],
    buyLink: "",
    status: "waitlist",
    priority: 8,
  ...
  {
    slug: "windows-enterprise-migration",
    title: "Windows Enterprise Migration Suite",
    tagline: "Upgrade your fleet to Windows 11 Enterprise with Entra ID (Azure AD) and modern management.",
    audience: "Business",
    audiences: ["Business"],
    price: 2499,
    priceNote: "Up to 15 workstations. Larger fleets: $149 per additional device.",
    ...
    notInScope: [
      ...
      "Server-room decommission (separate project)",
    ],
    buyLink: "",
    status: "waitlist",
    priority: 9,
