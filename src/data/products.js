...
export const products = [
  ...
  },
  {
    ...
    title: "AI Acceptable Use Policy + Governance Kit",
    tagline: "The policy every 2026 cyber-insurance renewal now asks for — pre-written for small offices running Copilot, ChatGPT, and Claude.",
    price: 59,
    audience: "Any Florida small business whose staff uses ChatGPT, Microsoft Copilot, Claude, Gemini, Notion AI, or any other generative-AI tool at work — which is all of them in 2026. HIPAA-covered practices and legal/financial firms have the highest exposure.",
    description:
      "A fully-drafted AI Acceptable Use Policy + Governance Program answering every question that appeared on Chubb, Travelers, Beazley, and Hiscox 2026 cyber-insurance renewals about AI use. Walks a 10-50 person office from 'we have no AI policy' to 'here it is, dated, signed, and audit-ready' in a weekend.",
    contents: [
      "AI Acceptable Use Policy (12 pages, fillable) — what staff can/can't put into ChatGPT, Copilot, Claude, Gemini, and Notion AI; covers PHI, PII, client data, financial data, source code, and trade secrets",
      "AI Tool Inventory spreadsheet — pre-populated rows for the 20 most-common workplace AI tools, with data-processing region, training-on-user-data flag, enterprise-vs-consumer license tier, and approval status",
      "Model-specific guidance pages — Microsoft 365 Copilot, ChatGPT (Team vs. Free), Claude (API vs. web), Gemini for Workspace, Notion AI: which tier meets HIPAA / FTC Safeguards / cyber-insurance requirements",
      "Prohibited-use enumeration — 18 specific scenarios (drafting legal opinions, writing patient letters from PHI, generating code handling PCI data, etc.) with plain-English rationale",
      "Prompt-logging + audit requirements matrix — what to log, how long to retain, who reviews",
      "Incident response addendum for AI-related events (prompt injection, data leak, hallucinated client communications, deepfake impersonation)",
      "Cyber-insurance questionnaire answer pack — 14 AI-specific questions from 2026 carrier forms with pre-written 'good posture' answers",
      "HIPAA-specific AI addendum — BAA requirements, PHI-handling rules, training-data exclusions (no extra cost)",
      "New-hire + refresher training one-pager — the single page every employee signs annually",
      "Governance review calendar — quarterly model / tool review prompts so the policy doesn't go stale six months after signing",
    ],
    buyLink: env.VITE_PRODUCT_AI_POLICY_BUY_URL || null,
    previewUrl: "/products/ai-acceptable-use-policy-preview.md",
    featured: true,
    priority: 11,
  },
  {
