...
export const GLOSSARY = [
  {
    ...
    why: "Every Florida medical, dental, and physical-therapy practice is HIPAA-covered. Your security reviewer won't quote you without seeing the Risk Assessment.",
    action:
  ...
  },
  {
    ...
    why: "Florida SaaS startups can't sell up-market without a SOC 2 in hand. Increasingly required by 2026 security renewals too.",
    action:
  ...
  },
  {
    ...
    why: "Without a WISP your insurance review goes up; with one you can answer the standard renewal questionnaire in 10 minutes.",
    action:
  ...
  },
  {
    ...
    why: "If your insurance renewal asks 'do you have MFA on every account?' the wrong answer raises review 14-30%. Hardware keys for admins is the 2026 baseline.",
    action:
  ...
  },
  {
    ...
    why: "Ransomware is the single most-feared scenario in every security reviewer's mind in 2026. Premiums skyrocket if your defenses don't show.",
    action:
  ...
  },
  {
    ...
    why: "If your security renewal questionnaire asks about 'centralized log monitoring,' your answer needs to demonstrate something — even M365 audit log review counts as a starting point.",
    action:
  ...
  },
  {
    ...
    why: "Without a current Risk Assessment, you fail the first question of any compliance audit. Your security reviewer wants a copy too.",
    action:
  ...
  },
  {
    ...
    full: [
      ...
      "Most security reviewers in 2026 ask whether you've run a tabletop in the last 12 months and require a sign-in sheet + summary document as evidence.",
    ...
    why: "A tabletop is the cheapest test of your Incident Response Plan you can run — and the evidence folder it produces is what reviewers want to see.",
    action:
      "Schedule a 90-minute tabletop this quarter using a real ransomware or BEC scenario. Use a realistic scenario, assign a note taker, and keep the sign-in sheet with your security records.",
  ...
  },
  {
    ...
    full: [
      ...
      "security reviewers in 2026 ask 'have you tested a restore from backup in the last 12 months' — having backups isn't enough; testing them is required. Most businesses discover their backups are unusable only after they need them.",
  ...
  },
  {
    ...
    action:
      "By June 1 each year: verify backups, test UPS units, photograph equipment, document the IT inventory. We use the same checklist with Sarasota and Bradenton clients before hurricane season.",
  ...
  },
  {
    ...
    why: "If your staff uses Copilot, ChatGPT, Claude, or Gemini at work and you don't have a written policy, your security renewal review goes up.",
    action:
